...
info "Mode: ${ROTATION_MODE}  mesh: ${MESH_PRESET}  nprocs=${NPROCS}  rpm=${RPM}"

export CASE_DIR ROTOR_STL STATOR_STLS STL_SCALE ROTATION_MODE
...
export ROTZONE_STL MESH_PRESET USE_BBOX_ORIGIN
